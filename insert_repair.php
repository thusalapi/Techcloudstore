...
$sql = "INSERT INTO Repairs (customer_id, phone_model, problem_description, estimated_cost, assigned_date, repair_status, return_date)
        VALUES ('$customer_id', '$phone_model', '$problem_description', '$estimated_cost', '$assigned_date', '$repair_status', '$return_date')";
